...
### 4. Budget & Logistique
* **Budget Dynamique :** 160 000 € de base + l'argent généré mensuellement par chaque bâtiment actif.
...
### Linux 🐧
1. Téléchargez l'archive (`Glacia_Linux.zip`) depuis les Releases.
2. Extrayez l'archive et ouvrez un terminal dans le dossier.
...
Ce projet utilise des musiques provenant du jeu **Undertale** créé par **Toby Fox**.
Ces assets sont utilisés à des fins strictement non-lucratives et éducatives.

* **Musique :** Toby Fox (Undertale)
* **Code Source :** Sous licence MIT (voir fichier LICENSE)
* **Art & Design :** Matteo Stroher
